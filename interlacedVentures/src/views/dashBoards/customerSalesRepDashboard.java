 ...
 * @author kcsar
 */
public class customerSalesRepDashboard extends javax.swing.JFrame {

    /**
     * Creates new form customerSalesRepDashboard
     */
    public customerSalesRepDashboard() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tableComplains = new javax.swing.JTable();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jButton1.setText("Back");

        jButton2.setText("Resolve Issues");
        ...
        jLabel1.setText("CUSTOMER SALES REPRESNTATIVE");

        tableComplains.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tableComplains);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customerSalesRepDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new customerSalesRepDashboard().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTable tableComplains;
